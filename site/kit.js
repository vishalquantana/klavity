...
// UTM first-touch attribution capture.
// Reads utm_source/medium/campaign from the URL query string on every page load,
// persists first-touch in localStorage (never overwrites), and exposes
// window.klavAttribution() for the login flow to attach to /api/auth/verify.
(function () {
  "use strict";
  var LS;
