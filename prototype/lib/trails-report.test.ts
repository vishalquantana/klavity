...
test("(render-2) output contains literal strings 'Generated by Klavity AutoSims' and 'klavity.in'", () => {
  const html = renderWalkReportHtml(makeData(), { baseUrl: "https://test.example", generatedAt: Date.now() })
  expect(html).toContain("Generated by Klavity AutoSims")
  expect(html).toContain("klavity.in")
})
